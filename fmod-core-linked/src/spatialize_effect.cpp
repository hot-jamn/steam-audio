...
namespace SteamAudioFMODCore {
    ...
    namespace SpatializeEffect {
        ...
        InitFlags lazyInit(FMOD_DSP_STATE* state,    int numChannelsIn,    int numChannelsOut)
        {
            ...
            // PRINT(std::format("Lazy init: numChannelsIn: {}, numChannelsOut: {}, samplingRate: {}, frameSize: {}, !gContext: {}, numChannelsIn, numChannelsOut, audioSettings.samplingRate, audioSettings.frameSize, !gContext));
        ...
        FMOD_RESULT F_CALLBACK process(FMOD_DSP_STATE* state, unsigned int length, const FMOD_DSP_BUFFER_ARRAY* inBuffers, FMOD_DSP_BUFFER_ARRAY* outBuffers, FMOD_BOOL inputsIdle, FMOD_DSP_PROCESS_OPERATION op);
        ...
        void setSource(FMOD_DSP_STATE* state, IPLSource source)
        {
            auto effect = reinterpret_cast<State*>(state->plugindata);
        ...
        IPLDirectEffectParams getDirectParams(FMOD_DSP_STATE* state, IPLCoordinateSpace3 source, IPLCoordinateSpace3 listener,
        ...
        void updateOverallGain(FMOD_DSP_STATE* state, IPLCoordinateSpace3 source, IPLCoordinateSpace3 listener)
        {
            auto effect = reinterpret_cast<State*>(state->plugindata);
            source.origin = { effect->x, effect->y, effect->z };
        ...
        FMOD_RESULT F_CALLBACK process(FMOD_DSP_STATE* state, unsigned int length, const FMOD_DSP_BUFFER_ARRAY* inBuffers, FMOD_DSP_BUFFER_ARRAY* outBuffers, FMOD_BOOL inputsIdle, FMOD_DSP_PROCESS_OPERATION operation)
        {
            auto effect = reinterpret_cast<State*>(state->plugindata);
